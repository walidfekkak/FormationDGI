...
attestation_url : string = 'https://attestation-qualif.tax.gov.ma/';
  ...
  getPDFAttestation(endpoint: string, custom_app_url?:string){
    let url = this.attestation_url + custom_app_url;
...
console.log("date list-master :"+date);
    ...
    var splittedVal = date.split('-');
    
    //console.log(obj)

    var obj = splittedVal[0]+splittedVal[1]+splittedVal[2];

    console.log("date convert ws "+ splittedVal[2]+splittedVal[1]+splittedVal[0]);
