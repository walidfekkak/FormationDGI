...
export class PaiementPage {
  ...
  constructor(private zone: NgZone,public toastCtrl: ToastController/*,private iab: InAppBrowser*/,private menu:MenuController,public navCtrl: NavController, public navParams: NavParams,public api:Api, private apiNative : ApiNative, public translateService: TranslateService) {
    this.translateService.get('ERREUR_3_MSG').subscribe((value) => {
      this.MSSG_INFO = value;
    });
  ...
  getLink(){
    ...
    //const httpHeader = {'montant':'1000','refPaiement':this.reference.ref,'email': this.reference.email,'modePaiement': '2'};
