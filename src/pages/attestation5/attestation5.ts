...
@IonicPage()
@Component({
  selector: 'page-attestation5',
  templateUrl: 'attestation5.html',
})
export class Attestation5Page {
  ...
  if (res.status_code == 302)    {  
    ...
    let url = this.api.getUrl('revenu', 'attestations/rest');
  //  url += '?idFiscal='+ this.user._user.identifiantFiscal +"&exercices="+this.selectedYears;// + '&email=' + this.email;
   url += "?idFiscal=40393781&exercices="+this.selectedYears;// + '&email=' + this.email;
